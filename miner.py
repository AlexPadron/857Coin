...
def solve_block(b):
    ...
    while True:
        ...
        #print("trying", n1, n2, n3)
        #   TODO: Check if we found a valid proof of work
        #   n1 == n2 == n3 % 2**d, n1 != n2 != n3
        if n1 % 2**d == n2 %2**d and n2 % 2**d == n3 % 2**d:
        	if b["nonces"][0] != b["nonces"][1] and b["nonces"][1] != b["nonces"][2] and b["nonces"][2] != b["nonces"][0]:
...
def main():
    ...
    """
    block_contents = "alex_p,vxia,xsoriano"
    while True:
